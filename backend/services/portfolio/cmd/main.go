...
import (
	...
	"invest/backend/services/portfolio/internal/config"
	"invest/backend/services/portfolio/internal/grpcserver"
	"invest/backend/services/portfolio/internal/health"
...
func main() {
	...
	log.Info("portfolio service starting", "addr", cfg.GRPCAddr)
